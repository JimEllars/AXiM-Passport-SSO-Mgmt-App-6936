/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 42a00767752c1dd096e4e4547a594bb3)
// Runtime types generated with workerd@1.20260907.1 2026-08-25 nodejs_compat
interface __BaseEnv_Env {
	REVOCATION_KV: KVNamespace;
	SECURITY_AUDIT_LOGS: KVNamespace;
	PASSPORT_ANALYTICS: AnalyticsEngineDataset;
	ANALYTICS: AnalyticsEngineDataset;
	AXIM_CORE_API_URL: "https://api.axim.us.com";
	PASSPORT_ORIGIN: "https://passport.axim.us.com";
	FRONTEND_ORIGINS: "https://passport.axim.us.com,https://axim-passport.pages.dev";
	ALLOWED_REDIRECT_ORIGINS: "https://nexus.axim.us.com,https://echo.axim.us.com,https://onyx.axim.us.com,https://greenmachine.axim.us.com,https://support.axim.us.com,https://asguard.axim.us.com,https://voice.axim.us.com,https://groundgame.axim.us.com,https://ceodept.axim.us.com";
	SUPABASE_URL: "https://pvbcdndqjguzqeafhwhw.supabase.co";
	WALLET_CHAIN_ID: "1";
	TURNSTILE_ACTION: "passport_auth";
	AUTH_STATE: DurableObjectNamespace<import("./src/index").AuthState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AuthState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AXIM_CORE_API_URL" | "PASSPORT_ORIGIN" | "FRONTEND_ORIGINS" | "ALLOWED_REDIRECT_ORIGINS" | "SUPABASE_URL" | "WALLET_CHAIN_ID" | "TURNSTILE_ACTION">> {}
}
