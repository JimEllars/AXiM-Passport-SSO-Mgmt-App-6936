...
const TurnstileBox = forwardRef(function TurnstileBox({ onToken, onError, resetKey }, ref) {
  ...
  return (
    <div className={`turnstile-wrap turnstile-${status}`}>
      ...
      {status === 'error' && (
        <div className="flex flex-col items-center bg-slate-900/80 border border-slate-700 p-4 rounded-lg w-full max-w-sm">
